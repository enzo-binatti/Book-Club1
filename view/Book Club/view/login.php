...
<body>
    ...
    <div class="login-card">
      ...
      <form id="loginForm" class="login-form">
        ...
        <div class="login-links">
          <a href="<?php echo generateLink('cadastro'); ?>">Criar uma conta</a>
          <a href="<?php echo generateLink('index.php'); ?>">Esqueci minha senha</a>
        </div>
      </form>
    </div>
  </div>
  ...
  <script>
    ...
    loginForm.addEventListener('submit', (event) => {
      ...
      // Verifica no localStorage (simulando banco de dados)
