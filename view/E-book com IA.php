  ...
  <div class="container">
    ...
    <div class="form-container">
      <div class="form-section">
        ...
        <button id="generateBtn" href="<?php echo generateLink('login'); ?>" class="btn"><i class="fas fa-sparkles"></i> Gerar E-book</button>
      </div>
      ...
      <div class="form-section">
        ...
        <input type="text" id="author" href="<?php echo generateLink('home'); ?>">
